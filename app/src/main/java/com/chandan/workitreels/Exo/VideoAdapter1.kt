package com.chandan.workitreels.Exo
...
import com.chandan.workitreels.databinding.SingleVideoRowBinding
...
import com.google.android.exoplayer2.upstream.DefaultDataSource
    ...
    class VideoAdapter1(
        ...
        override fun onBindViewHolder(holder: VideoViewHolder, position: Int) {
            ...
            holder.binding.textVideoAccountTitle.text = model.title
            holder.setVideoPath(model.url)

            holder.binding.textVideoDescription.text = model.desc
            holder.setVideoPath(model.url)
        }
