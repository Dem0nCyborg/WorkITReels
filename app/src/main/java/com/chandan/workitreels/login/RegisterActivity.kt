...
import com.chandan.workitreels.databinding.ActivityRegisterBinding
...
//  Click
    ...
    private fun showTextMinimalAlert(isNotValid: Boolean, text : String){
        if (text == "Username")
            ...
            binding.etPassword.error = if (isNotValid) "$text must be longer than 8 characters" else null
    }
    ...
    private fun showPasswordConfirmAlert(isNotValid: Boolean){
        binding.etConfirmPassword.error = if (isNotValid) "Passwords are not same" else null
    }
}